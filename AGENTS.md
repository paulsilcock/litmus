...
The canonical guidance for this repository lives in `CLAUDE.md` (project context
and the Vite+ toolchain) and `.claude/rules/` (the TDD workflow and code-quality
